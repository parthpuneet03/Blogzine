          ...
          <ul className="navbar-nav navbar-nav-scroll mx-auto">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="homeMenu">
                ...
                <li>
                  {" "}
                  <a className="dropdown-item active" href="index-lazy">
                    Home lazy load
                  </a>
                </li>
                <li>
                  ...
                  <div className="row g-4 p-3 flex-fill">
                    ...
                    <div className="col-sm-6 col-lg-3">
                      <div className="card bg-transparent">
                        {/* Card img */}
                        <img
                          className="card-img rounded lazy"
                          data-src="assets/images/blog/16by9/small/01.jpg"
                          alt="Card image"
                        />
                    ...
                    <div className="col-sm-6 col-lg-3">
                      <div className="card bg-transparent">
                        ...
                        <img
                          className="card-img rounded lazy"
                          data-src="assets/images/blog/16by9/small/02.jpg"
                          alt="Card image"
                        />
                        <div className="card-body px-0 pt-3">
                          <h6 className="card-title mb-0">
                    ...
                    <div className="col-sm-6 col-lg-3">
                      <div className="card bg-transparent">
                        ...
                        <img
                          className="card-img rounded lazy"
                          data-src="assets/images/blog/16by9/small/03.jpg"
                          alt="Card image"
                        />
                        <div className="card-body px-0 pt-3">
                          <h6 className="card-title mb-0">
        ...
        <div className="row g-0">
          <div className="col-12">
            <div className="alert alert-danger" role="alert">
              This page has a Lazy load enabled. We have used compressed images
              on our theme so, based on your internet speed you might won’t see
              lazy loading images as images get loaded instantly. You can also
              check{" "}
              <a
                className="alert-link"
                target="_blank"
                href="docs/lazy-load.html"
              >
      ...
      <div className="container">
        <div className="row g-4">
          ...
          <div className="col-lg-6">
            <div
              className="card card-overlay-bottom card-grid-lg card-bg-scale lazy"
              data-bg="assets/images/blog/1by1/01.jpg"
              style={{
          ...
          <div className="col-lg-6">
            <div className="row g-4">
              ...
              <div className="col-12">
                <div
                  className="card card-overlay-bottom card-grid-sm card-bg-scale lazy"
                  data-bg="assets/images/blog/1by1/02.jpg"
                  style={{
                    backgroundPosition: "center left",
                    backgroundSize: "cover"
                  }}
              ...
              <div className="col-md-6">
                <div
                  className="card card-overlay-bottom card-grid-sm card-bg-scale lazy"
                  data-bg="assets/images/blog/1by1/03.jpg"
                  style={{
                    backgroundPosition: "center left",
                    backgroundSize: "cover"
                  }}
              ...
              <div className="col-md-6">
                <div
                  className="card card-overlay-bottom card-grid-sm card-bg-scale lazy"
                  data-bg="assets/images/blog/1by1/04.jpg"
                  style={{
                    backgroundPosition: "center left",
                    backgroundSize: "cover"
                  }}
                ...
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      ...
                      data-src="assets/images/blog/4by3/01.jpg"
                      alt="Card image"
                    />
              ...
              <div className="col-sm-6">
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      className="card-img lazy"
                      data-src="assets/images/blog/4by3/06.jpg"
                      alt="Card image"
                    />
                    <div className="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* Card overlay Top */}
              ...
              <div className="col-sm-6">
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      className="card-img lazy"
                      data-src="assets/images/blog/4by3/03.jpg"
                      alt="Card image"
                    />
                    <div className="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* Card overlay bottom */}
              ...
              <div className="col-sm-6">
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      className="card-img lazy"
                      data-src="assets/images/blog/4by3/04.jpg"
                      alt="Card image"
                    />
                    <div className="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* Card overlay bottom */}
              ...
              <div className="col-sm-6">
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      className="card-img lazy"
                      data-src="assets/images/blog/4by3/05.jpg"
                      alt="Card image"
                    />
                    <div className="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* Card overlay Top */}
                      <div className="w-100 mb-auto d-flex justify-content-end">
                        <div className="text-end ms-auto">
                          {/* Card format icon */}
                          <div
                            className="icon-md bg-white bg-opacity-10 bg-blur text-white rounded-circle"
              ...
              <div className="col-sm-6">
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      className="card-img lazy"
                      data-src="assets/images/blog/4by3/12.jpg"
                      alt="Card image"
                    />
                    <div className="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* Card overlay bottom */}
                    ...
                    <div className="row g-3">
                      <div className="col-4">
                        <img
                          ...
                          data-src="assets/images/blog/4by3/thumb/01.jpg"
                          alt=""
                        />
                      </div>
                      <div className="col-8">
                  ...
                  <div className="card mb-3">
                    <div className="row g-3">
                      <div className="col-4">
                        <img
                          className="rounded lazy"
                          data-src="assets/images/blog/4by3/thumb/02.jpg"
                          alt=""
                        />
                      </div>
                      <div className="col-8">
                  ...
                  <div className="card mb-3">
                    <div className="row g-3">
                      <div className="col-4">
                        <img
                          className="rounded lazy"
                          data-src="assets/images/blog/4by3/thumb/03.jpg"
                          alt=""
                        />
                      </div>
                      <div className="col-8">
                  ...
                  <div className="card mb-3">
                    <div className="row g-3">
                      <div className="col-4">
                        <img
                          className="rounded lazy"
                          data-src="assets/images/blog/4by3/thumb/04.jpg"
                          alt=""
                        />
                      </div>
                      <div className="col-8">
              ...
              >
                ...
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      className="card-img lazy"
                      data-src="assets/images/blog/4by3/07.jpg"
                      alt="Card image"
                    />
                    <div className="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* Card overlay Top */}
                ...
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      className="card-img lazy"
                      data-src="assets/images/blog/4by3/08.jpg"
                      alt="Card image"
                    />
                    <div className="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* Card overlay bottom */}
                ...
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      className="card-img lazy"
                      data-src="assets/images/blog/4by3/09.jpg"
                      alt="Card image"
                    />
                    <div className="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* Card overlay bottom */}
                ...
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      className="card-img lazy"
                      data-src="assets/images/blog/4by3/10.jpg"
                      alt="Card image"
                    />
                    <div className="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* Card overlay Top */}
                ...
                <div className="card">
                  ...
                  <div className="position-relative">
                    <img
                      className="card-img lazy"
                      data-src="assets/images/blog/4by3/11.jpg"
                      alt="Card image"
                    />
                    <div className="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* Card overlay bottom */}
