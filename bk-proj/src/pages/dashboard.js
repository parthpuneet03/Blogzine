        ...
        <div className="nav flex-nowrap align-items-center">
          ...
          <div className="nav-item ms-2 ms-md-3 dropdown">
            ...
            >
              ...
              <li className="dropdown-divider mb-2" />
              <li>
                  ...
                  <div className="col-12">
                    <div className="d-flex align-items-center position-relative">
                      ...
                      <div className="ms-3">
                        <p className="mb-1">
                          {" "}
                          <a className="h6 fw-normal stretched-link" href="#">
                            {" "}
                ...
                <div className="custom-scrollbar h-350">
                  <div className="row">
                      ...
                      <div className="d-flex justify-content-between position-relative">
                        <div className="d-sm-flex">
                          <div className="icon-lg bg-success bg-opacity-10 text-success rounded-2 flex-shrink-0">
                            <i className="bi bi-chat-left-quote-fill fs-5" />
                          </div>
                          {/* Info */}
                          <div className="ms-0 ms-sm-3 mt-2 mt-sm-0">
                            <h6 className="mb-0">
                      ...
                      <div className="d-flex justify-content-between position-relative">
                        <div className="d-sm-flex">
                          ...
                          <div className="ms-0 ms-sm-3 mt-2 mt-sm-0">
                            ...
                            <p className="mb-0">
                              Weddings believed prospect Arrived
                            </p>
                            <span className="small">4 hour ago</span>
                          </div>
                        </div>
                    ...
                    <div className="col-12">
                      <div className="d-flex justify-content-between position-relative">
                        <div className="d-sm-flex">
                          <div className="icon-lg bg-primary bg-opacity-10 text-primary rounded-2 flex-shrink-0">
          ...
          <div className="col-md-6 col-xxl-4">
            <div className="card border h-100">
              ...
              <div className="card-header border-bottom d-flex justify-content-between align-items-center p-3">
                ...
                <a href="#" className="btn btn-sm btn-link p-0 mb-0 text-reset">
                  View all
                </a>
              </div>
              {/* Card body START */}
              <div className="card-body p-4">
                ...
                <div className=" mx-auto">
                  <div id="apexChartTrafficSources" />
                </div>
                {/* Content */}
                <ul className="list-inline text-center mt-3">
                  <li className="list-inline-item pe-2">
                    <i className="text-primary fas fa-circle pe-1" /> Search{" "}
                  </li>
                  <li className="list-inline-item pe-2">
                    <i className="text-success fas fa-circle pe-1" /> Direct{" "}
                  </li>
                  <li className="list-inline-item pe-2">
                    <i className="text-danger fas fa-circle pe-1" /> Social{" "}
                  </li>
                  <li className="list-inline-item pe-2">
                    <i className="text-warning fas fa-circle pe-1" /> Display
                    ads{" "}
                  </li>
                </ul>
              </div>
