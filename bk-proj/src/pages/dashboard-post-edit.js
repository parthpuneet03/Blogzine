                    ...
                    <div className="col-12">
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          defaultValue="Ten tell-tale signs you need to get a new startup."
                        />
                        <small>
                          Moving heaven divide two sea female great midst spirit
                        </small>
                      </div>
                    </div>
                    {/* Post type START */}
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <p>
                            ...
                            <b>
                              The exercise of. Up attempt offered ye civilly so
                            ...
                            followed handsome drawings entirely Mrs one yet
                            outweigh. Of acceptance insipidity remarkably is an
                            invitation.{" "}
                          </p>
                          <br />
                          <blockquote>
                            ...
                            although the material does the exercise of. Speedily
                            say has suitable disposal add boy. On forth doubt
                            ...
                            balls, death own point now men. Match way these she
                            avoids seeing death. She who drift their fat off.{" "}
                          </blockquote>
                          <br />
                          <p>
                            Valley by oh twenty direct me so. Departure
                            defective arranging rapturous did believe him all
                            had supported. Family months lasted simple set
                            nature vulgar him. Picture for attempt joy excited
                            ten carried manners talking how. Suspicion neglected
                            he resolving agreement perceived at an.
                          </p>
                          <br />
                          <ol>
                            <li>Ecstatic followed handsome drawings.</li>
                            <li>
                              But discretion frequently sir she instruments
                              unaffected admiration everything.{" "}
                            </li>
                            <li>
                              Ecstatic followed handsome drawings entirely Mrs
                              one yet outweigh.
                            </li>
                            <li>
                              Up attempt offered ye civilly so sitting to. She
                              new course gets.
                            </li>
                            <li>
                              Prudence attachment him his for sympathize. Large
                              above be to means.
                            </li>
                          </ol>
                          <br />
                          <p>
                            ...
                            moreover in sensible it ye possible. Fulfilled
                            direction use continual set him propriety continued.
                            Saw met applauded favorite deficient engrossed
                            concealed and her. Concluded boy perpetual old
                            supposing. Farther related bed and passage comfort
                            civilly. Dashwoods see frankness objection
                            abilities. As hastened oh produced prospect formerly
                            up am. Placing forming nay looking old married few
                            has. Margaret disposed of add screened rendered six
                    ...
                    <div className="col-lg-7">
                      ...
                      <div className="mb-3">
                        ...
                        <textarea
                          className="form-control"
                          rows={1}
                          defaultValue={"business, sports, traveling"}
                        />
                        <small>
