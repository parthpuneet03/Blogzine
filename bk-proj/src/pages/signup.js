                      ...
                      <div className="row g-4 p-3 flex-fill">
                        ...
                        <div className="col-sm-6 col-lg-3">
                          <div className="card bg-transparent">
                            ...
                            <div className="card-body px-0 pt-3">
                              <h6 className="card-title mb-0"><a href="post-single-2.html" className="btn-link text-reset fw-bold">7 common mistakes everyone makes while traveling</a></h6>
                              {/* Card info */}
                        ...
                        <div className="col-sm-6 col-lg-3">
                          <div className="card bg-transparent">
                            ...
                            <div className="card-body px-0 pt-3">
                              <h6 className="card-title mb-0"><a href="post-single-2.html" className="btn-link text-reset fw-bold">12 worst types of business accounts you follow on Twitter</a></h6>
                              {/* Card info */}
                              <ul className="nav nav-divider align-items-center text-uppercase small mt-2">
                                <li className="nav-item">
                        ...
                        <div className="col-sm-6 col-lg-3">
                          <div className="card bg-transparent">
                            ...
                            <div className="card-body px-0 pt-3">
                              <h6 className="card-title mb-0"><a href="post-single-2.html" className="btn-link text-reset fw-bold">Skills that you can learn from business</a></h6>
                              {/* Card info */}
                              <ul className="nav nav-divider align-items-center text-uppercase small mt-2">
                                <li className="nav-item">
                ...
                <div className="bg-primary bg-opacity-10 rounded p-4 p-sm-5">
                  ...
                  <form className="mt-4">
                    ...
                    <div className="mb-3">
                      ...
                      <input type="email" className="form-control" value={user} onChange={(event)=> setUser(event.target.value)} id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="E-mail" />
                      <small id="emailHelp" className="form-text">We'll never share your email with anyone else.</small>
                    </div>
                    {/* Password */}
                    <div className="mb-3">
                      <label className="form-label" htmlFor="exampleInputPassword1">Password</label>
                      <input type="password" className="form-control" value={pass1} onChange={(event)=> setPass1(event.target.value)} id="exampleInputPassword1" placeholder="*********" />
                    </div>
                    {/* Password */}
                    <div className="mb-3">
                      <label className="form-label" htmlFor="exampleInputPassword2">Confirm Password</label>
                      <input type="password" className="form-control" value={pass2} onChange={(event)=> setPass2(event.target.value)} id="exampleInputPassword2" placeholder="*********" />
                    </div>
                    {/* Checkbox */}
                    <div className="mb-3 form-check">
                      <input type="checkbox" className="form-check-input" id="exampleCheck1" />
                      <label className="form-check-label" htmlFor="exampleCheck1">Yes i'd also like to sign up for additional subscription</label>
                    </div>
                    {/* Button */}
                    <div className="row align-items-center">
                      <div className="col-sm-4">
                        <button type="submit" onClick={handleSignup} className="btn btn-success">Sign me up</button>
                      </div>
                  ...
                  <div className="text-center">
                    ...
                    <ul className="list-unstyled d-sm-flex mt-3 justify-content-center">
                      <li className="mx-2">
                        <a href="#" className="btn bg-facebook d-inline-block"><i className="fab fa-facebook-f me-2" /> Sign up with Facebook</a>
                      </li>
                      <li className="mx-2">
                        <a href="#" className="btn bg-google d-inline-block"><i className="fab fa-google me-2" /> Sign up with google</a>
                      </li>
                    </ul>
                  </div>
                </div>
